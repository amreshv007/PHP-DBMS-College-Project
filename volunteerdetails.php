...
//echo $_POST['submit'];
$var=$_POST['submit'];
$qry='SELECT * FROM volunteer WHERE p_key='.$var;
...
echo '
		...
		Name: '.$result1['f_name'].'
	  '.$result1['l_name'].'</br>
	  village: '.$result1['village'].'</br>
	  region: '.$result1['region'].'</br>
	  Contact No: '.$result1['contact'].'</br>
	  District: '.$result1['district'].'</br>
	';
echo '</div>';
?>
<div style="height:200px;background-color:#17202A ;margin-top:40px ">
